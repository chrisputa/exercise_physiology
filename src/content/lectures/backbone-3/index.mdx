...
import fig1 from '../../../assets/biochemistry_01_energy_systems.png';
import fig1Dark from '../../../assets/biochemistry_01_energy_systems_dark.png';
import fig2 from '../../../assets/Cellular_Respiration_bw.png';
import fig2Dark from '../../../assets/generated/Cellular_Respiration_bw_dark.png';
import fig3 from '../../../assets/biochemistry_02_atp_yield.png';
import fig3Dark from '../../../assets/biochemistry_02_atp_yield_dark.png';
import fig4 from '../../../assets/biochemistry_03_fat_cho_crossover.png';
import fig4Dark from '../../../assets/biochemistry_03_fat_cho_crossover_dark.png';
...
<Figure src={fig1} srcDark={fig1Dark} alt="ATP resynthesis rate of the three energy systems against effort duration">
...
<Figure src={fig2} srcDark={fig2Dark} alt="Cellular respiration">
...
<Figure src={fig3} srcDark={fig3Dark} alt="ATP yield per mole of substrate and the resulting Pasteur effect">
...
<Figure src={fig4} srcDark={fig4Dark} alt="Relative contribution of fat and carbohydrate to energy supply across exercise intensity">
