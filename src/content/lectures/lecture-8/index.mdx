...
5. [Conceptual Model for RT Implementation Across LTAD Stages](#5-conceptual-model-for-rt-implementation-across-ltad-stages)
...
The seven sequential stages of the Long-Term Athlete Development (LTAD) model (Balyi, Way & Higgs, 2013).
</Fragment>
</Table>
...
<Fragment slot="caption">
Physical qualities emphasised across maturation in the Youth Physical Development (YPD) model (Lloyd & Oliver, 2012). ✓✓ = high priority, ✓ = supported, — = not primary focus. MC = metabolic conditioning.
</Fragment>
</Table>
...
## 5 Conceptual Model for RT Implementation Across LTAD Stages
...
<Fragment slot="caption">
Evidence-based interventions to reduce the exercise-induced immunological stress response in youth athletes (Puta & Gabriel, 2018).
</Fragment>
</Table>
