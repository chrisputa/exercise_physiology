...
import fig1 from '../../../assets/wearables_01_ledebur_rhr_cohorts.png';
import fig1Dark from '../../../assets/generated/wearables_01_ledebur_rhr_cohorts_dark.png';
import { Note } from '../../../components/MarginNote/index.js';


## Table of Contents

1. [The Condition and the Population Signal](#1-the-condition-and-the-population-signal)
2. [Predicting the Flare — Mechanism and Practice](#2-predicting-the-flare--mechanism-and-practice)

---

## 1 The Condition and the Population Signal

<Note>
**Learning objectives:**
- Infection-associated chronic illness and the WHO post-COVID-19 condition
- Episodic symptoms as the case for wearables over point-in-time measurement
- Pre-infection and acute-phase wearable signatures, and the predictive features of PCC
</Note>

### 1.1 Introduction -- Infection-Associated Chronic Illness
...
### 1.2 The Role of Wearable Technology in Chronic Illness Research
...
### 1.3 Wearable-Derived Characteristics of Persistent Symptoms After SARS-CoV-2 Infection
...
### Key References
- Aitken A et al. (2026) Digital physiological biomarkers predict within-person symptom changes in complex chronic illness. *npj Digital Medicine* 9:257.
- Ledebur K et al. (2025) Wearable data reveals distinct characteristics of individuals with persistent symptoms after a SARS-CoV-2 infection. *npj Digital Medicine* 8:167.

---

## 2 Predicting the Flare — Mechanism and Practice

<Note>
**Learning objectives:**
- Within-person vs between-person effects in multilevel models
- Morning HR and HRV — level and instability — as predictors of same-evening symptoms
- The autonomic mechanism linking HRV, vagal tone and inflammation, and the limits of PPG monitoring
</Note>

### 2.1 Digital Physiological Biomarkers for Symptom Prediction in Complex Chronic Illness
...
### 2.2 Autonomic Nervous System Mechanisms
...
### 2.3 Clinical and Practical Implications
